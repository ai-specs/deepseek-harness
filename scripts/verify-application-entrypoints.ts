...
const MANIFEST_BIN_ALLOWLIST = new Map<string, ManifestBin>([
  ...
  ['packages/integration/plugin-kestra-run/package.json', { 'dsh-run': 'bin/dsh-run.mjs' }],
])
...
const EXECUTABLE_SOURCE_ALLOWLIST = new Map<string, string>([
  ...
  ['packages/integration/plugin-kestra-run/bin/dsh-run.mjs', 'dsh launcher for kestra relayed headless runs'],
