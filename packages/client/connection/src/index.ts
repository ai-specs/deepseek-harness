...
export async function apply(ctx: Context, config?: ConnectionConfig): Promise<void> {
  ...
  ctx.inject(['webServer'], (webCtx) => {
    ...
    if (browserAuth instanceof OidcBrowserAuth) {
      ...
      webCtx.effect(() => webCtx.webServer.register(callbackRoute), 'client-connection: oidc callback route')
      ...
      webCtx.effect(() => webCtx.webServer.register(whoamiRoute), 'client-connection: whoami route')
      webCtx.effect(() => webCtx.webServer.register(logoutRoute), 'client-connection: logout route')
    }
  })
