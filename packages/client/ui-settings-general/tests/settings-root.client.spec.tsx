...
// Fork UI keeps SettingsRoot without the upstream settings.launcher slot (UserSection owns the identity entry); these upstream tests target that slot.
it.skip('explicitly reopens one onboarding editor during an existing session', () => {
...
it.skip('opens Account from the contributed sidebar launcher', () => {
