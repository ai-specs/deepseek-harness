...
| 属性 | 存在性 | 类型 |
|---|---|---|
| `content` | 必需 | [`ContentBlock[]`](#persistence-type-sha256-d2dea97bf59a9533fa69ff7f7da5f4e1800e74d577bbe82c2c1aab14564d5b10) |
| `id` | 必需 | `string` |
| `role` | 必需 | `"assistant"` |
...
[`AssistantStreamRecord`](#persistence-type-sha256-889f17dcd997f4bb54689d6bb3307efe206283eec55b3eb96a95be7e08443a80) 的数组。
...
[`ContentBlock`](#persistence-type-sha256-2f4e033157106e535215b2d3f39b44c15bffbc88f30e979bcda9810476529b43) 的数组。
...
[`Message`](#persistence-type-sha256-2e2604e0cf6567b47abf9a19ccca95ef5c6a1a3a9d4b81e3f20e45ed69e31795) 的数组。
...
| `maxTokens` | 必需 | `number` |
| `messageSeqs` | 必需 | [`number[]`](#persistence-type-sha256-5d03ba38734809bcbd2a55221bd938b3b3fc34b49bb686c6113e9e4931e3aa78) |
| `messages` | 必需 | [`Message[]`](#persistence-type-sha256-bce490e03de81fa6f9efdd4abf3bd3587115b18c209e0989f8f79d25aae7e683) |
...
来源：[`packages/llm/llm-deepseek/src/tool-result-block.ts:15`](../packages/llm/llm-deepseek/src/tool-result-block.ts)
...
[`UserMessage`](#persistence-type-sha256-02b09ca76e42dda90d7e34148911027698c01b5f09e60bde09b36bc153802b9d) 的数组。
...
| `model` | 必需 | `string` |
| `provider` | 必需 | `string` |
| `rawOutput` | 必需 | [`ContentBlock[]`](#persistence-type-sha256-d2dea97bf59a9533fa69ff7f7da5f4e1800e74d577bbe82c2c1aab14564d5b10) |
...
| `sourceCommandId` | 可选 | `string` |
| `summary` | 必需 | [`ContentBlock[]`](#persistence-type-sha256-d2dea97bf59a9533fa69ff7f7da5f4e1800e74d577bbe82c2c1aab14564d5b10) |
...
| `model` | 必需 | `string` |
| `provider` | 必需 | `string` |
| `rawOutput` | 可选 | [`ContentBlock[]`](#persistence-type-sha256-d2dea97bf59a9533fa69ff7f7da5f4e1800e74d577bbe82c2c1aab14564d5b10) |
| `shadowedRange` | 必需 | [`{ end, start }`](#persistence-type-sha256-9e41386b3a0c9572b0d63078492ebb3997da7d3a830d44e0259418bd02f4bcb2) |
| `shadowedSeqs` | 必需 | [`number[]`](#persistence-type-sha256-5d03ba38734809bcbd2a55221bd938b3b3fc34b49bb686c6113e9e4931e3aa78) |
| `shadowedTokenCount` | 必需 | `number` |
| `sourceCommandId` | 可选 | `string` |
...
|---|---|---|
| `error` | 可选 | [`{ code, name, reason? }`](#persistence-type-sha256-a81059ca06999da1e712414520c2c65e491d052fcf9640fae20aa38f0a5dc735) |
| `message` | 必需 | [`ToolResultMessage`](#persistence-type-sha256-132edaad35eeb27a7f8491f5286f1ce1f5b2d2be59a82aaa29fa7add67914442) |
...
|---|---|---|
| `headerSeq` | 可选 | `number` |
| `message` | 必需 | [`DeveloperMessage`](#persistence-type-sha256-40d438139c13ef025f97b20d172b30a4f54f9d87bd07a4febed48f8b99958177) |
| `step` | 必需 | `number` |
| `turn` | 必需 | `number` |
...
| 属性 | 存在性 | 类型 |
|---|---|---|
| `inserted` | 必需 | [`UserMessage[]`](#persistence-type-sha256-d3b965004253ae7b61bcfaadd846e13928a072eec821acc717dbc4ae7be12888) |
| `outcome` | 可选 | `"canceled"` |
...
|---|---|---|
| `interrupted` | 可选 | `true` |
| `message` | 必需 | [`AssistantMessage`](#persistence-type-sha256-d3ff6feeba6330d007351c2a37cf23b10643fcaa72946c16343e209ee75e42e0) |
| `step` | 必需 | `number` |
| `stream` | 必需 | [`AssistantStreamRecord[]`](#persistence-type-sha256-5a1756c1aab039e0ef9ce9fd3a35815789934cdf015b7eed7c7eeb7b429c9388) |
| `turn` | 必需 | `number` |
| `usage` | 可选 | [`TokenUsage`](#persistence-type-sha256-fec5442b9ee4122e10514d81d5a43648003fe8bfb7ee2ba50c0cdbdd383ed394) |
...
| 属性 | 存在性 | 类型 |
|---|---|---|
| `message` | 必需 | [`SystemMessage`](#persistence-type-sha256-5d7cab2e58220d02339effac2eb46c2367795e2f2a9facb90267e924edd228a8) |
| `step` | 必需 | `number` |
| `turn` | 必需 | `number` |
...
| 属性 | 存在性 | 类型 |
|---|---|---|
| `message` | 必需 | [`TeamMessageSnapshot`](#persistence-type-sha256-cabab39e29d209f290f89fae4c7731252b9d69ae4fc476bf8895ae2e0de8c88a) |
| `teamId` | 必需 | `string` |
| `version` | 必需 | `2` |
...
| 属性 | 存在性 | 类型 |
|---|---|---|
| `data` | 必需 | [`{ inserted, outcome?, removedCount?, start, … }`](#persistence-type-sha256-b48febbe549c31cd7656757016639fc82ad4a505e94203f6ac2d809a75167e9f) |
| `ignorable` | 可选 | `true` |
| `seq` | 必需 | `number` |
| `time` | 必需 | `number` |
...
| 属性 | 存在性 | 类型 |
|---|---|---|
| `data` | 必需 | [`{ step, stream, turn }`](#persistence-type-sha256-a6949734361f9b28fe7c324832debfe30e5dd1ae88cb73607a2eb960b1a66b78) |
| `ignorable` | 可选 | `true` |
| `seq` | 必需 | `number` |
| `time` | 必需 | `number` |
...
| 属性 | 存在性 | 类型 |
|---|---|---|
| `data` | 必需 | [`{ interrupted?, message, step, stream, … }`](#persistence-type-sha256-340ffe6654c11a3141a58a868601441e9fe4a271b1566c1298d7f11cb046693c) |
| `ignorable` | 可选 | `true` |
| `seq` | 必需 | `number` |
| `surfaceOp` | 必需 | [`SurfaceOp`](#persistence-type-sha256-335e242de1fcc17b6ca920fc420d71bec2d76e53e37955c00948b65ab77f05c5) |
| `time` | 必需 | `number` |
...
| 属性 | 存在性 | 类型 |
|---|---|---|
| `block` | 必需 | [`ContentBlock`](#persistence-type-sha256-2f4e033157106e535215b2d3f39b44c15bffbc88f30e979bcda9810476529b43) |
| `index` | 必需 | `number` |
| `type` | 必需 | `"block-end"` |
...
| 属性 | 存在性 | 类型 |
|---|---|---|
| `blockType` | 必需 | [`ContentBlockType`](#persistence-type-sha256-0c3db19eb333ce406f1bb20e0c2a0d2f6cfa8a39b89dd87e5fcef21ad85485ff) |
| `index` | 必需 | `number` |
| `type` | 必需 | `"block-start"` |
...
| 属性 | 存在性 | 类型 |
|---|---|---|
| `chunk` | 必需 | [`StreamChunk`](#persistence-type-sha256-21014c6c4a04a872d2f9c714c569772f53211bf6e5717d1a00982db3a9ff8f15) |
| `time` | 必需 | `number` |
| `type` | 必需 | `"chunk"` |
...
| 属性 | 存在性 | 类型 |
|---|---|---|
| `data` | 必需 | [`union (2 variants)`](#persistence-type-sha256-1eb0547288e4de3ab539f213afb8516a60eb169b6f86dd42ee66d40448673ef0) |
| `ignorable` | 可选 | `true` |
| `seq` | 必需 | `number` |
| `time` | 必需 | `number` |
...
| 属性 | 存在性 | 类型 |
|---|---|---|
| `data` | 必需 | [`{ headerSeq?, message, step, turn }`](#persistence-type-sha256-bbdeccf17d5a1f27c55c74b924bbb4f5ee3cdb4975311c55172aa198fab57646) |
| `ignorable` | 可选 | `true` |
| `seq` | 必需 | `number` |
| `sourceEventSeqs` | 可选 | [`number[]`](#persistence-type-sha256-5d03ba38734809bcbd2a55221bd938b3b3fc34b49bb686c6113e9e4931e3aa78) |
| `surfaceOp` | 必需 | [`SurfaceOp`](#persistence-type-sha256-335e242de1fcc17b6ca920fc420d71bec2d76e53e37955c00948b65ab77f05c5) |
...
| 属性 | 存在性 | 类型 |
|---|---|---|
| `data` | 必需 | [`SessionTitleLlmRequestEventData`](#persistence-type-sha256-b19113db6d490f8e5838ea2d2d554a91a69e1880276206650d45f30530c1be93) |
| `ignorable` | 可选 | `true` |
| `seq` | 必需 | `number` |
| `time` | 必需 | `number` |
...
| 属性 | 存在性 | 类型 |
|---|---|---|
| `data` | 必需 | [`{ message, step, turn }`](#persistence-type-sha256-9f21fca879b3f64875d8562b2ac0c64e9beb23d5e54b791df9259765329ca241) |
| `ignorable` | 可选 | `true` |
| `seq` | 必需 | `number` |
| `sourceEventSeqs` | 可选 | [`number[]`](#persistence-type-sha256-5d03ba38734809bcbd2a55221bd938b3b3fc34b49bb686c6113e9e4931e3aa78) |
| `surfaceOp` | 必需 | [`SurfaceOp`](#persistence-type-sha256-335e242de1fcc17b6ca920fc420d71bec2d76e53e37955c00948b65ab77f05c5) |
...
| 属性 | 存在性 | 类型 |
|---|---|---|
| `data` | 必需 | [`{ message, teamId, version }`](#persistence-type-sha256-1797f959594f315889132cbddef1c3bbac32c54dbb276d544bab233c1debc9e9) |
| `ignorable` | 可选 | `true` |
| `seq` | 必需 | `number` |
| `time` | 必需 | `number` |
...
| 属性 | 存在性 | 类型 |
|---|---|---|
| `data` | 必需 | [`PtcDispatchEventData`](#persistence-type-sha256-9e815da08af5624e2e992671422da0dd7f4401581e1ada65acf664576fa4cfae) |
| `ignorable` | 可选 | `true` |
| `seq` | 必需 | `number` |
| `time` | 必需 | `number` |
...
| 属性 | 存在性 | 类型 |
|---|---|---|
| `data` | 必需 | [`{ error?, message, meta?, step, … }`](#persistence-type-sha256-8fa73136a9fc7eeb27912dd7334461c365b3a06e5e35632ca046e81abc9b2fab) |
| `ignorable` | 可选 | `true` |
| `seq` | 必需 | `number` |
| `sourceEventSeqs` | 可选 | [`number[]`](#persistence-type-sha256-5d03ba38734809bcbd2a55221bd938b3b3fc34b49bb686c6113e9e4931e3aa78) |
| `surfaceOp` | 必需 | [`SurfaceOp`](#persistence-type-sha256-335e242de1fcc17b6ca920fc420d71bec2d76e53e37955c00948b65ab77f05c5) |
...
| 属性 | 存在性 | 类型 |
|---|---|---|
| `data` | 必需 | [`UserMessage`](#persistence-type-sha256-02b09ca76e42dda90d7e34148911027698c01b5f09e60bde09b36bc153802b9d) |
| `ignorable` | 可选 | `true` |
| `seq` | 必需 | `number` |
| `sourceEventSeqs` | 可选 | [`number[]`](#persistence-type-sha256-5d03ba38734809bcbd2a55221bd938b3b3fc34b49bb686c6113e9e4931e3aa78) |
| `surfaceOp` | 必需 | [`SurfaceOp`](#persistence-type-sha256-335e242de1fcc17b6ca920fc420d71bec2d76e53e37955c00948b65ab77f05c5) |
